...
cmake -DBuild_CLI=OFF -DBuild_C_wrapper=ON -DBuild_C_wrapper_with_core=ON -DEnable_CUDA=on ..
make -j$(nproc)
...
echo "All finished."
echo "Your wheel file of pyanime4k with CUDA was stored in $INSTALLATION_PATH"
